...
namespace Project445.MembershipService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MembershipService.IService1")]
    public interface IService1 {
        ...
        Project445.MembershipService.Movie[] SearchMovies(string query);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SearchMovies", ReplyAction="http://tempuri.org/IService1/SearchMoviesResponse")]
        System.Threading.Tasks.Task<Project445.MembershipService.Movie[]> SearchMoviesAsync(string query);
        ...
        Project445.MembershipService.Movie[] GetUpcomingMovies();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetUpcomingMovies", ReplyAction="http://tempuri.org/IService1/GetUpcomingMoviesResponse")]
        System.Threading.Tasks.Task<Project445.MembershipService.Movie[]> GetUpcomingMoviesAsync();
        ...
        Project445.MembershipService.Movie[] GetNowPlayingMovies();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetNowPlayingMovies", ReplyAction="http://tempuri.org/IService1/GetNowPlayingMoviesResponse")]
        System.Threading.Tasks.Task<Project445.MembershipService.Movie[]> GetNowPlayingMoviesAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : Project445.MembershipService.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<Project445.MembershipService.IService1>, Project445.MembershipService.IService1 {
        ...
        public Project445.MembershipService.Movie[] SearchMovies(string query) {
            return base.Channel.SearchMovies(query);
        }
        
        public System.Threading.Tasks.Task<Project445.MembershipService.Movie[]> SearchMoviesAsync(string query) {
            return base.Channel.SearchMoviesAsync(query);
        }
        
        public Project445.MembershipService.Movie[] GetUpcomingMovies() {
            return base.Channel.GetUpcomingMovies();
        }
        
        public System.Threading.Tasks.Task<Project445.MembershipService.Movie[]> GetUpcomingMoviesAsync() {
            return base.Channel.GetUpcomingMoviesAsync();
        }
        
        public Project445.MembershipService.Movie[] GetNowPlayingMovies() {
            return base.Channel.GetNowPlayingMovies();
        }
        
        public System.Threading.Tasks.Task<Project445.MembershipService.Movie[]> GetNowPlayingMoviesAsync() {
